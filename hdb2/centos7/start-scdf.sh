...
start_scdf_shell () {
  ...
  echo -e 'stream create --definition "http --server.port=9000  | hdfs --hdfs.fs-uri=hdfs://centos7-namenode:8020 --hdfs.directory=/demo --hdfs.file-name=demoData --hdfs.rollover=10000" --name demo --deploy' >> demo.cmd
